...
--
-- Host: localhost
-- Generation Time: Jun 04, 2025 at 03:36 AM
...
CREATE TABLE `diabetes` (
  `id` int NOT NULL,
  `dx` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ket` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gejala` longtext COLLATE utf8mb4_general_ci,
  `gbrgejala` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `saran` longtext COLLATE utf8mb4_general_ci,
  `gbrsaran` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `tag` varchar(1000) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `nummin` int DEFAULT NULL,
  `nummax` int DEFAULT NULL
